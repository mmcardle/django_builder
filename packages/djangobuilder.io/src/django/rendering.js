import Django from "@djangobuilder/core"
...
if (isNode) { 
  ...
  import('./python/settings.py?raw').then((module)=> settings = module.default)
  import('./python/manage.py?raw').then((module)=> manage = module.default)
  import('./python/manage.py?raw').then((module) => manage = module.default);
  import('./python/wsgi.py?raw').then((module) => wsgi = module.default);
  import('./python/urls.py?raw').then((module) => urls = module.default);
  import('./python/views.py?raw').then((module) => views = module.default);
  import('./python/asgi.py?raw').then((module) => asgi = module.default);
  import('./python/htmx.py?raw').then((module) => htmx = module.default);
  import('./python/routing.py?raw').then((module) => routing = module.default);
  import('./python/consumers.py?raw').then((module) => consumers = module.default);
  import('./python/app_consumers.py?raw').then((module) => app_consumers = module.default);
  import('./requirements/requirements.txt?raw').then((module) => requirements_txt = module.default);
  import('./tests/test_settings.py?raw').then((module) => test_settings = module.default);
  import('./tests/test_requirements.txt?raw').then((module) => test_requirements_txt = module.default);
  import('./tests/pytest.ini?raw').then((module) => _pytest_ini = module.default );
  import('./templates/base.html.tmpl?raw').then((module) => _base_html = module.default );
  import('./templates/channels_websocket.html.tmpl?raw').then((module) => _channels_websocket_html = module.default );
  import('./templates/htmx.html.tmpl?raw').then((module) => _htmx_html = module.default)
  import('./templates/htmx/create.html?raw').then((module) => htmx_create = module.default)
  import('./templates/htmx/delete_button.html?raw').then((module) => htmx_delete_button = module.default)
  import('./templates/htmx/form.html?raw').then((module) => htmx_form = module.default)
  import('./templates/htmx/list.html?raw').then((module) => htmx_list = module.default)
}
